...
<div id="content" >
	...
	<div class=" mrgin_bot_5" style='width:100%; text-indent: 10px;'>
	...
	<div>
		<div class="post_body mrgin_top_10 f_left" style='width:100%'>
            <?php if(isset($fotos[0]['path'])): ?>
                <div class="foto_slider mrgin_bot_10">
                    <div id="foto_1" style="text-align:center">
						<img src="<?=Helper::getBU()?><?=$fotos[0]['path']; ?>" width="609px" height="379px" />
					</div>
                </div>
            <?php endif; ?>
