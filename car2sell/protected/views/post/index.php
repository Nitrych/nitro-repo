        ...
        <?php foreach($posts as $post): ?>
            <div class="post_row bd_bot_ds_c8">
                ...
                <div class="post_info f_left">
                    <h3 class="title fs_lh_14_20 bold pding_10_0"><a href="#"><?php echo $post->title; ?></a></h3>
                    <p class="color_b4 fs_lh_11_14">Toyota</p>
                    <p class="color_b4 fs_lh_11_14">Новосибирск</p>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
