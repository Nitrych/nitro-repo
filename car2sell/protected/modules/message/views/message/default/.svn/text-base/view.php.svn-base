...
<h1><?php echo MessageModule::t('Сообщение'); ?></h1>
...
<div style="width:100%; background-color:#f0efef; margin-bottom:20px">
<?php if ($isIncomeMessage): ?>
	<h2 class="message-from">Автор: <?php echo $viewedMessage->getSenderName() ?></h2>
<?php else: ?>
